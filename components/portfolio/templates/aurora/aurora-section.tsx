...
const contentStyles: Record<AuroraSectionVariant, string> = {
  ...
  honors:
    "mx-auto max-w-5xl px-4 sm:px-6 aurora-honors-content [&_[data-portfolio-section]_h2]:sr-only [&_[data-portfolio-section]_.grid]:grid-cols-1 [&_[data-portfolio-section]_.grid]:gap-4 [&_[data-portfolio-section]_.grid>div]:flex-row [&_[data-portfolio-section]_.grid>div]:items-center [&_[data-portfolio-section]_.grid>div]:gap-5 [&_[data-portfolio-section]_.grid>div]:rounded-none [&_[data-portfolio-section]_.grid>div]:border [&_[data-portfolio-section]_.grid>div]:border-violet-500/15 [&_[data-portfolio-section]_.grid>div]:bg-background [&_[data-portfolio-section]_.grid>div]:p-4 [&_[data-portfolio-section]_.grid>div]:shadow-none sm:[&_[data-portfolio-section]_.grid>div]:p-5 [&_[data-portfolio-section]_.grid>div_svg]:mt-0 [&_[data-portfolio-section]_.grid>div_svg]:h-8 [&_[data-portfolio-section]_.grid>div_svg]:w-8 [&_[data-portfolio-section]_.grid>div_svg]:text-rose-500",
  voices:
