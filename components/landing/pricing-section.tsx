    ...
    <section id="pricing" className="relative py-20 sm:py-28">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <FadeIn className="mt-14 grid gap-8 lg:grid-cols-2 lg:gap-10" delay={100}>
          <Tilt max={6} lift={12}>
            <PremiumCard>
              <Card className="h-full border-border/70 bg-card/75 backdrop-blur-md">
                <CardHeader>
                  <CardTitle className="text-2xl">Free</CardTitle>
                  <CardDescription>
                    Everything you need to publish your first portfolio.
                  </CardDescription>
          ...
          <Tilt max={6} lift={14} float={!reducedMotion}>
            <PremiumCard>
              <Card
                className={cn(
                  "relative h-full overflow-hidden border-primary/30 shadow-lg",
                  "bg-gradient-to-br from-primary/[0.08] via-background/80 to-amber-500/[0.06] backdrop-blur-md",
                )}
              >
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    For serious job seekers and freelancers.
                  </CardDescription>
                  <p className="pt-2 text-4xl font-bold tracking-tight">
